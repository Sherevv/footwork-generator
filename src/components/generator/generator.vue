<div>
    ...
    <div class="generator">
        ...
        <div class="generator-btns">
            ...
            <div class="generator-btn">
                <el-button type="warning" @click="generate([])">
                    <it-svgicon icon="lightning"></it-svgicon> {{t('Generate')}}
                </el-button>
            </div>
    ...
    <vue-headful :title="t('TITLE')" :lang="$route.params.lang" :description="t('META_DESCRIPTION')" :keywords="t('META_KEYWORDS')"/>

<template>
  <div>
    <h1 class="main-header">
      <span v-translate>Footwork_Generator</span> {{ version }}
    </h1>
    <div class="generator">
      <div class="cards">
        <div
          ...
          v-bind:key="i"
          class="card-block"
          :class="['row' + options.bit_count]"
        >
          <div v-if="options.show_bits" class="card-index">
            <span class="badge">{{ i + 1 }}</span>
          </div>
          <div
            v-if="i % options.bit_count === 0 && options.show_row_index"
            class="row-index"
          >
          ...
          <div
            v-if="options.step_names"
            class="card-lbl"
            :class="card.label_class"
          >
            {{ card.step }}
          </div>
        ...
        <el-collapse-item name="1" :key="$translate.current">
          ...
          <div class="well">
            ...
            <div class="row">
              <div class="col2">
                <p>
                  <label v-translate>Number_of_bits</label><br />
                ...
                <p>
                  <label class="label-radio">
                    <el-switch
                      v-model="options.rock_step"
                      :inactive-color="swOffClr"
                      :disabled="options.manual_mode"
                    ></el-switch>
                ...
                <p>
                  <label class="label-radio">
                    <el-switch
                      v-model="options.kick_instead_hold"
                      :inactive-color="swOffClr"
                      :disabled="!options.step_names"
                    ></el-switch>
              ...
              <div class="col2">
                <p>
                  <label>{{ t('Evenness') }}:</label>
                  <el-select
                    v-model="options.evenness"
                    :key="$translate.current"
                  >
                    <el-option
                      :label="t('No_matter')"
                ...
                <p>
                  <label class="label-radio">
                    <el-switch
                      v-model="options.show_row_index"
                      :inactive-color="swOffClr"
                    ></el-switch>

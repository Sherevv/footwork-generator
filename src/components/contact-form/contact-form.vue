<template>
  <div id="contentForm" collapse="isCollapsed" v-cloak>
    <div id="form" class="content text">
      <form id="ContactForm" name="ContactForm" @submit.prevent="onSubmit"
            @keydown="formErrors.clear($event.target.name)" @change="onFormChange">
        <fieldset>
          <div class="form-group">
            <el-input type="text" class="form-control" name="name" id="name" value="" :placeholder="t('Name')"
          ...
          <div class="form-group">
            ...
            <el-input type="email" name="email" id="email" value="" placeholder="E-mail" v-model="contact.email">
              <template #prepend>
          ...
          <div class="form-group">
            <div class="input-group el-input el-input-group el-input-group--prepend">
              <div class="el-input-group__prepend">
                <span class="ast">*</span><br>
                <it-svgicon icon="message" class="icon-form"></it-svgicon>
              </div>
              <el-input type="textarea" name="message" id="message" :rows="5" :placeholder="t('Message')"

...
const GeneratorComponent = () =>
    import(/* webpackChunkName: "generator" */ '../components/generator');
const DescriptionComponent = () =>
    import(/* webpackChunkName: "description" */ '../components/description');
const ExercisesComponent = () =>
    import(/* webpackChunkName: "exercises" */ '../components/exercises');
